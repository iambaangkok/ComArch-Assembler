...
public class AssemblerTest {
    ...
    public void testToNumeric(){
        Assert.assertEquals(1, Assembler.toDecimal("1"));
        Assert.assertEquals(-1, Assembler.toDecimal("-1"));
        Assert.assertEquals(1234567, Assembler.toDecimal("1234567"));
        Assert.assertEquals(-11111111, Assembler.toDecimal("-11111111"));
    }
